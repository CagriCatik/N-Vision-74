...
### [SolidWorks Web Help — Inserting and Resizing Sketch Pictures](https://help.solidworks.com/2018/English/SolidWorks/sldworks/t_insert_and_resize_pictures.htm)
...
### [YouTube — How To Insert Scaled Blueprint Images In Solidworks](https://www.youtube.com/watch?v=T0ISIMIB2Xk)

Useful for seeing the image import, scale, and transparency workflow visually.

### [YouTube — How to Import and Trace an Image in SOLIDWORKS](https://www.youtube.com/watch?v=ILormJ4H0jQ)
...
### [SolidWorks Web Help — Recommendations for Lofts with Guide Curves](https://help.solidworks.com/2021/English/SolidWorks/sldworks/c_Recommendations_Lofts_Guide_Curves.htm)
...
### [MLC CAD — Complete SOLIDWORKS Surfacing Tutorial](https://www.mlc-cad.com/resources/solidworks/complete-solidworks-surfacing-tutorial-step-by-step-guide/)

Useful for understanding general surface creation, trimming, knitting, and turning surfaces into solids.

### [Engineers Rule — The SOLIDWORKS Boundary Surface Feature](https://www.engineersrule.com/the-solidworks-boundary-surface-feature/)

Useful for understanding when Boundary Surface may be more flexible than Lofted Surface for complex patches.

### [Hawk Ridge Systems — 3 Steps to Better Lofts and Boundaries in SOLIDWORKS](https://hawkridgesys.com/blog/3-steps-better-lofts-boundaries-solidworks)

Useful for avoiding bad loft or boundary surface geometry.

### [YouTube — Design a Car in SOLIDWORKS Step-by-Step Surface Tutorial](https://www.youtube.com/watch?v=yxeJnAEIS_w)

Useful as a practical car-body surfacing reference.

### [YouTube — Loft Surface in SolidWorks](https://www.youtube.com/watch?v=PS3Yp9uwK2w)

Useful for a short visual example of loft surfaces and guide curves.

## SolidWorks and 3D printing export

### [SolidWorks Web Help — Exporting 3D Print Files](https://help.solidworks.com/2025/English/SolidWorks/sldworks/t_exporting_3D_print_files.htm)
...
### [MySolidWorks — STL Files](https://my.solidworks.com/reader/onlinehelp/2021%252Fenglish%252Fsolidworks%252Fsldworks%252Fc_stl_files.htm/stl-files-stl)

Useful for understanding STL/3MF/AMF export options.

### [The SolidWorks Expert — Optimize SolidWorks Models for 3D Printing](https://www.thesolidworksexpert.com/post/how-to-optimize-your-solidworks-models-for-3d-printing)

Useful for practical SolidWorks-to-print preparation, including export and model checks.

### [YouTube — How to Export STL Files in SolidWorks](https://www.youtube.com/watch?v=b6VONCqFIgY)
...
### [3D Demand — Design Guidelines for FDM 3D Printing](https://www.3d-demand.com/blog/design-guidelines-for-fdm-3d-printing-wall-thickness-tolerances-file-prep)
...
### [Stratasys Direct — FDM Material Tolerance Guide](https://www.stratasys.com/en/stratasysdirect/resources/resource-guides/fdm-material-tolerance/)
...
### [SolidWorks Blog — Design and Create a Remote Control Car](https://blogs.solidworks.com/products/solidworks/solidworks-for-makers-design-and-create-a-remote-control-car-part-1/)

Useful for maker-focused RC car design using SolidWorks.

### [Instructables — 3D Printed RC Car](https://www.instructables.com/3D-Printed-RC-Car/)

Useful for practical assembly and printed vehicle design considerations.

### [GitHub — 3D-Printed-RC-Car-Design](https://github.com/Ahm3d0x/3D-Printed-RC-Car-Design)

Useful as an example of a complete 3D-printed RC car design project.

### [GrabCAD — SolidWorks car models](https://grabcad.com/library/software/solidworks/tag/car)

Useful for studying CAD structure and modelling approaches.

!!! warning
    Do not treat downloaded files as automatically printable; inspect them first.
...
- [Bambu Lab A1 mini technical specifications](https://bambulab.com/en/a1-mini/tech-specs) — build volume 180 x 180 x 180 mm.
- [Bambu Lab P1S product/spec information](https://eu.store.bambulab.com/products/p1s) — enclosed printer, useful for ABS and other higher-temperature materials.
- [Bambu Lab filament guide](https://wiki.bambulab.com/en/general/filament-guide-material-table) — printer, nozzle, build plate, compatibility and material guidance.
- [Bambu Lab PLA guide](https://wiki.bambulab.com/en/filament/pla) — includes PLA-specific operation notes and chamber-temperature related clogging risk.
